...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamed2512000/kgtfile/master/GetVersion.txt' ) or 0
...
return '⋆اصدار سورس برينجو : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'⋆** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس جوجل يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
local inline = {{{text="-قنآهہ‏‏ آلسـورس اضـغـط هـنـآ ",url="https://t.me/bringo_13"}}}
send_key(msg.sender_user_id_,'   [قناة سورس : برينجو](https://t.me/bringo_13)' ,nil,inline,msg.id_)
return false
end
...
return [[
⋆  ━━━  𝒃𝒓𝒊𝒏𝒈𝒐 ♫  ━━━ ⋆
 [ 𝒃𝒓𝒊𝒏𝒈𝒐 ♫  ](https://t.me/Bringo_1) 💌 .
 [ 𝒎𝒂𝒅𝒊𝒔𝒐𝒏 ♫ ](https://t.me/ahhh_maaaa) 💌 .
  [𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒓𝒊𝒏𝒈𝒐 ♫ ](https://t.me/bringo_13) 💌 .
⋆  ━━━  𝒃𝒓𝒊𝒏𝒈𝒐 ♫   ━━━ ⋆
]]
end
...
elseif Text== "جوجل" or Text== "بكار" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس برينجو](https://t.me/Bringo_1)")
